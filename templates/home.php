...
<form action="#" method="POST">
    Limit: <input type="text" name="limit" value="<?php echo $_POST['limit'];?>"> <input type="submit" value="Show">
</form>
    ...
    if($FBObject){
        ...
        foreach ($FBObject as $element) {
            ...
            <tr <?php echo $myclass;?>>
                ...
                <td><a href="<?php echo $element['link'];?>" target="_blank"><? echo substr($element['link'], 0, 50);?></a></td>
                ...
                <td>
                    ...
                    else echo "<font color='red'><a href='http://projects.geekydump.com/fb-comments-importer/' target='_blank'>-- PRO Feature --</a></font>";
                    ?>
                </td>
                <td>
                    <?php
                    ...
                    else echo "<font color='red'>Not avaliable</font>";
                    ?>
                </td>
            </tr>
    <?php
